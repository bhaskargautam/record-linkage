'''
    Record Linkage Testing Script for FEBRL dataset using ECM Classifier method.
    Note: Throws ValueError due to inconsistent values for jaro method.
'''
...
def main():
    ...
    logrg = recordlinkage.ECMClassifier(init='random', binarize='float')
    logrg.fit(features)
